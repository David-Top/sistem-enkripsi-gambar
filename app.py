...
def encrypt_func():
    ...
    if request.files:
        ...
        if mode == "cbc":
            ...
            start_time = time.time()
            ciphertext1 = ecb_encrypt(plaintext, cipher_key)
            run_time1 = time.time() - start_time
            ...
            ciphertext1_i_key = ecb_encrypt(plaintext, cipher_key_i)
            ciphertext1_i_plaintext = ecb_encrypt(plaintext_i, cipher_key)
